/*
 * @Author: lujiafeng
 * @Date: 2022-01-14 10:38:42
 * @LastEditTime: 2022-03-14 16:14:53
 * @LastEditors: lujiafeng
 * @Description: 数据类型检测
 * @FilePath: \utils\script\dataType\typeCheck.ts
 ...
 * @returns true | false
 */
export function isNullPlainObject(obj: object): boolean {
 ...
 * @returns true | false
 */
export function isFunction(obj: Array<any> | Object | string | number | boolean | Function): boolean {
  return toString.call(obj) === '[object Function]'
}


/**
 * @description 判断输入的两个数据是否完全相等
 * @param a 数据1
 * @param b 数据2
 * @param aStack 
 * @param bStack 
